...
from vlla.policy import BasePolicy, DummyPolicy, MetaWorldDummyPolicy
...
def make_policy(policy_config: Dummy | MetaWorld) -> BasePolicy:
...
@dataclass
class Args:
    policy: Dummy | MetaWorld = field(default_factory=Dummy)
    host: str = "0.0.0.0"
    port: int = 8765
